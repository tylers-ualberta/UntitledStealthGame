...
def run():
    ...
    while running:
        ...
        screen.blit(wall5.surf, wall5.rect)
        screen.blit(wall6.surf, wall6.rect)
        screen.blit(wall7.surf, wall7.rect)
        screen.blit(wall8.surf, wall8.rect)
        screen.blit(wall9.surf, wall9.rect)
