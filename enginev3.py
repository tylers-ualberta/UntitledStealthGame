...
class Cone(Enemy):
    def __init__(self, offset, orientation="left", speed=0, colour=(255, 255, 0)):
        ...
        self.rect = [pygame.Rect(offset[0], offset[1]+ 15, 24, 170),pygame.Rect(offset[0] + 24, offset[1] + 30, 24, 140),
                    pygame.Rect(offset[0] + 48, offset[1] + 45, 24, 110), pygame.Rect(offset[0] + 72, offset[1] + 60, 24, 80),
                    pygame.Rect(offset[0] + 96, offset[1] + 75, 24, 50), pygame.Rect(offset[0] + 120, offset[1] + 90, 24, 20),
                    pygame.Rect(offset[0] + 144, offset[1] + 95, 8, 10)]
        self.offset = offset
